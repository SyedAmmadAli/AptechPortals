		...
		<div class="sidebar-menu">
			<ul id="accordion-menu">
				...
				<li class="dropdown">
					...
					<ul class="submenu">
						<!-- <li><a href="Employee_Attn_marking.php">Mark Employees Attedance</a></li> -->
						<li><a href="attendance.php">Mark Students Attedance</a></li>
						<li><a href="Attandance_std.php">View Students Attendance</a></li>
						<li><a href="Attandance_std_s.php">View Month Attendance</a></li>
				...
				<li class="dropdown">
					<a href="javascript:;" class="dropdown-toggle">
						<span class="micon dw dw-edit2"></span><span class="mtext">Assignments</span>
					</a>
					<ul class="submenu">
						<!-- <li><a href="Employee_Attn_marking.php">Mark Employees Attedance</a></li> -->
						<li><a href="create_assignment.php">Create Assignments</a></li>
						<li><a href="display_assignment.php">Display Assignments</a></li>
						<li><a href="grade_assignment.php">Assign Grades</a></li>
				...
				<li class="dropdown">
					...
					<ul class="submenu">
						<li><a href="facul_gp_ajax.php">View GPA</a></li>
						<!-- <li><a href="abc.php">Add Event</a></li> -->
						<!-- <li><a href="">Delete Event</a></li> -->
					</ul>
				</li>
				...
				<li class="dropdown">
					<a href="javascript:;" class="dropdown-toggle">
						<span class="micon dw dw-apartment"></span><span class="mtext"> E-Project Request</span>
					</a>
					<ul class="submenu">
						<li><a href="faculty_create_group.php">Create Groups</a></li>
						<!-- <li><a href="abc.php">Add Event</a></li> -->
						<!-- <li><a href="">Delete Event</a></li> -->
					</ul>
				</li>
